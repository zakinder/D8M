...
set_property DIRECTION OUT [get_ports {mipi_cs_n[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {mipi_cs_n[0]}]
set_property DRIVE 12 [get_ports {mipi_cs_n[0]}]
set_property SLEW SLOW [get_ports {mipi_cs_n[0]}]
set_property DIRECTION OUT [get_ports {camera_pwdn_n[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {camera_pwdn_n[0]}]
set_property DRIVE 12 [get_ports {camera_pwdn_n[0]}]
set_property SLEW SLOW [get_ports {camera_pwdn_n[0]}]
...
set_property DIRECTION OUT [get_ports {mipi_reset_n[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {mipi_reset_n[0]}]
set_property DRIVE 12 [get_ports {mipi_reset_n[0]}]
set_property SLEW SLOW [get_ports {mipi_reset_n[0]}]
